...
| Jeu | Compétence | Une course donne droit à | Touches |
|---|---|---|---|
| Mastermind | Déduction combinatoire | Une proposition de code | 4 |
| Memory | Mémorisation et transmission orale | Deux cartes retournées | 3 |
| Bataille navale | Déduction spatiale | Un tir | 1 |
...
Tout se joue directement sur le plateau : aucun écran intermédiaire, aucun message à attendre. Le coureur touche, le résultat s'affiche sur place, il repart.
...
1. **Manche 1, rien.** Les élèves découvrent que retenir des positions de tête, à quatre, ne fonctionne pas.
...
Impose que le coureur **annonce ses deux cartes à voix haute dès son arrivée**, avant que quiconque écrive.
...
- **Mastermind** : les six couleurs sont en bas de chaque colonne. Quatre touches valident la proposition automatiquement ; le bouton d'effacement annule la dernière couleur.
- **Memory** : la rangée du bas sert de sélecteur d'équipe et de compteur de paires. La grille prend la couleur de l'équipe active. Une paire trouvée reste visible avec un liseré à la couleur de l'équipe qui l'a trouvée.
- **Bataille navale** : chaque équipe joue directement sur sa grille. Sous la grille, les quatre bateaux restants sont figurés par leur longueur.
...
- **Réglages** : nombre d'équipes de 2 à 5, durée d'affichage du Memory, taille de la grille de bataille navale.
...
| Classe à l'aise | Memory à 1,2 s, bataille navale en 10 × 10 |
| Manches de moins de 10 minutes | Bataille navale en 8 × 8 obligatoirement |

La flotte compte quatre bateaux de 5, 4, 3 et 3 cases, soit quinze cases. En 8 × 8 elles occupent un quart de la mer et il faut compter une quarantaine de tirs pour tout couler ; en 10 × 10, un septième de la mer et environ soixante-cinq tirs.
